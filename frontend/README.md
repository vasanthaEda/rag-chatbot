...
This project is maintained by Manmohan S., a Supply Chain Analyst with over 4 years of experience in data analysis, operational reporting, and process improvement. Leveraging a technical background in SQL and Python, this repository supports the development of tools designed to improve reporting accuracy and operational visibility.
